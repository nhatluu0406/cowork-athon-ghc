...
export function postgresRole(paths: StackPaths, ports: StackPorts, password: string): GenericStartSpec {
...
export function neo4jRole(paths: StackPaths, ports: StackPorts): GenericStartSpec {
...
export function llmSvcRole(paths: StackPaths, ports: StackPorts): GenericStartSpec {
...
export function backendRole(paths: StackPaths, ports: StackPorts, secrets: { jwtSecret: string; pgPassword: string }): GenericStartSpec {
