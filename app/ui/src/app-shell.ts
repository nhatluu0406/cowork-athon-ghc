...
interface AppDom {
  ...
  knowledgePanel: KnowledgePanelDom | null;
  knowledgePanelHost: HTMLElement;
...
function refreshKnowledgePanel(state: AppState, dom: AppDom): void {
  ...
  if (!dom.knowledgePanel) {
    ...
    const knowledgeInvocation: KnowledgeToolInvocation | null = null; // Placeholder for Phase 3
