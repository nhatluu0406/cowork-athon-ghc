 ...
 */
import type { ApprovalLevel, PermissionActionKind, PermissionDecision, PermissionScope } from "@cowork-ghc/contracts";
/**
...
export declare function createPermissionClient(call: BoundaryCall): PermissionClient;
