 ...
 */
import { KNOWLEDGE_PANEL_MAX_NODES, } from "@cowork-ghc/service/knowledge/types";
function initializeLayout(nodes, width, height) {
    const map = new Map();
...
function simulateLayout(layoutNodes, edges, iterations = 30) {
...
export function createKnowledgeGraphView(host, config) {
    ...
    const edgeContainer = svg("g", { class: "knowledge-graph-edges" });
    const nodeContainer = svg("g", { class: "knowledge-graph-nodes" });
...
//# sourceMappingURL=knowledge-graph-view.js.map