...
export function createAppFrame(root) {
    ...
    const infoButton = el("button", "icon-btn topbar__info no-drag");
    ...
    const newConversationButton = el("button", "sidebar__new-btn icon-only-btn");
    ...
    coworkSidebarPanel.append(coworkToolbar, workspaceLabel, workspaceBox, el("h2", "sidebar__heading", "Phiên"), sessionList);
    ...
    const skillsButton = el("button", "composer-skills-btn");
    ...
    composerBar.append(attachButton, skillsButton, providerControl.root, el("div", "composer__spacer"), cancelButton, sendButton);
    ...
    shellFrame.append(productRail, sidebar, coworkView, workspaceView.root, knowledgeView.root, integrationSurface, rightPanel);
