...
import type { AttachmentMetadata, ConversationRecord, ConversationStatus, ConversationSummary, RuntimeTurnRecord, ServiceClient, SkillUseMetadata } from "./service-client.js";
...
export interface ConversationManager {
    ...
    recordUserMessage(text: string, attachments?: readonly AttachmentMetadata[], skills?: readonly SkillUseMetadata[]): Promise<void>;
