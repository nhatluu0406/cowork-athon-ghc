...
const RECOVERABLE = new Set(["not_connected", "unreachable"]);
...
export function createReadinessView(container, opts) {
    ...
    function update(state) {
        ...
        if (recoverable && prevPhase !== state.phase)
            retry.focus();
...
//# sourceMappingURL=readiness-view.js.map