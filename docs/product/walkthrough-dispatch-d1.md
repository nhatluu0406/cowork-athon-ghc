...
| `@` command (chèn file/context) | ✅ Có typeahead `@`-mention: chèn `@<path>` vào composer **và tự đính kèm nội dung file** vào ngữ cảnh (guarded workspace read, cùng luồng chip như nút kẹp ghim; dedupe theo path) (`7fdb067` + attach) |
